...
flag1 = uicontrol(d,"Style","text",'position', [270 30 150 20],"string","$\Gamma(s)=\int_0^\infty t^{s-1}\mathrm{e}^{-t}\,\mathrm{d}t$");
flag2 = uicontrol(d, 'style', 'label', 'position', [270 30 150 20], 'string', 'Черный v / Зеленый o', 'background', [1 1 1], 'value', 0);
